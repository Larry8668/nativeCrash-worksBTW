...
const MoreInfo = () => {
  return (
    <div className="flex flex-col md:flex-row space-y-6 space-x-4 p-3 my-3 mx-5 md:mx-9 ">
      <div>
      <p className="text-lg font-normal text-gray-500 lg:text-2xl dark:text-gray-400 text-justify md:text-justify">
